...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Serial",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6Serial11AppDelegate")
...
SWIFT_CLASS("_TtC6Serial15BluetoothSerial")
@interface BluetoothSerial : NSObject <CBCentralManagerDelegate, CBPeripheralDelegate>
...
@property (nonatomic, strong) CBUUID * _Nonnull characteristicUUID;
...
SWIFT_CLASS("_TtC6Serial12GradientView")
...
SWIFT_CLASS("_TtC6Serial21ScannerViewController")
@interface ScannerViewController : UIViewController <UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, weak) IBOutlet UIBarButtonItem * _Null_unspecified tryAgainButton;
...
SWIFT_CLASS("_TtC6Serial20SerialViewController")
@interface SerialViewController : UIViewController <UITextFieldDelegate>
...
@property (nonatomic, weak) IBOutlet UIBarButtonItem * _Null_unspecified barButton;
@property (nonatomic, weak) IBOutlet UINavigationItem * _Null_unspecified navItem;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified LED;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified Left;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified Right;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified Forward;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified Reverse;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified Stop;
- (IBAction)LEDtoggle:(id _Nonnull)sender;
...
- (void)back;
- (void)stop;
- (IBAction)barButtonPressed:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
